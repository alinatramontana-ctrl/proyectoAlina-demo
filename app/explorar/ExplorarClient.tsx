...
export default function ExplorarClient() {
  ...
  // ✅ delay fix (lo mantenemos): mantener la anterior hasta que cargue la nueva
  ...
  return (
    <main className="relative h-screen w-screen bg-black text-white overflow-hidden">
      {/* Mobile: BLOQUEAMOS EXPLORAR */}
      <div className="sm:hidden relative min-h-screen bg-[#EAEAEA] text-slate-900">
        <TopLeftMenu backHref="/" />

        <section className="min-h-screen flex items-center justify-center px-6 py-16">
          <div className="w-full max-w-md">
            <h1 className="text-center text-4xl tracking-tight text-[#183e4b]">
              Explorar
            </h1>
            <p className="mt-3 text-center text-slate-600">
              Esta vista está optimizada para PC.
            </p>

            <div className="mt-8 rounded-[26px] bg-[#EAEAEA] p-5 shadow-xl border border-black/10">
              <div className="rounded-2xl bg-white p-6 border border-black/10">
                <p className="text-sm text-slate-700">
                  En celular podés usar estas opciones:
                </p>
                ...
                <p className="mt-4 text-[11px] text-[#183e4b]/70">
                  Tip: si querés ver el plano con hotspots, abrilo desde una PC.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* Desktop: EXPLORAR ORIGINAL (solo PC) */}
